...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            unitarios es 
            \begin{equation*}
                \rho = \{\frac{v_1}{w_i}, \ldots, \frac{v_n}{w_n}\}
                     = \{u_1, \ldots, u_n\}
            \end{equation*}
            ...
            \begin{enumerate}
                ...
                \begin{enumerate}
                    ...
                    pues estamos considerando los tesoros correspondientes a 
                    $C_1$ y $C_2$. Como todavía hay espacio, entonces volvemos 
                    a repetir el algoritmo sobre el conjunto $C_3$.
                \end{enumerate}
            \end{enumerate}

            Podemos resolver esta recurrencia utilizándo el Teorema Maestro:
            ...
            \begin{align*}
                T(n) &\in \Theta(n^k) \quad \quad si a < b^k \\
                T(n) &\in \Theta(n^k \log (n)) \quad \quad si a = b^k \\
                T(n) &\in \Theta(n^{\log_b (a)}) \quad \quad si a > b^k
            \end{align*}
            ...
            entonces con $a = 1, b = 2, c = 1, k = 1$ la solución a la 
            recurrencia es $\Theta(n)$. 
            
            Por lo tanto, la complejidad total de nuestro algoritmo es 
            $\Theta(n)$.
