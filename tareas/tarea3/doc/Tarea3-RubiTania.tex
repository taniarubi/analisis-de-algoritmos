...
\begin{enumerate}
    ...
    usando memoización con el arreglo $A[n][m]$. Ahora bien, los ciclos 
    \texttt{while} de los pasos $2$ y $3$ nos toman $\Theta(m)$ y 
    $\Theta(n)$, respectivamente; pues estamos recorriendo una sola vez un 
    renglón y una columna. Y el ciclo \texttt{while} del paso $5$ nos toma 
    $\Theta(nm)$, ya que estamos recorriendo lo que queda de la matriz $A$ 
    (entrada por entrada). Por lo tanto, la complejidad total del algoritmo 
    es de $\Theta(nm)$.
