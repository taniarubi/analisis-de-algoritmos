    ...
    \begin{enumerate}
        ...
        \begin{proof}
            ...
            \begin{itemize}
                ...
                \begin{itemize}
                    \item El huevo se rompe, lo que implica que $f=k+1$. Por 
                    hipótesis de inducción, tenemos que $k$ es el número 
                    mínimo de experimentos para determinar a $f$ si sólo 
                    tenemos un huevo. Así, para obtener el número mínimo de 
                    experimentos del siguiente piso debemos sumar este valor 
                    más uno.

                    \item El huevo no se rompe, lo que implica que $f=k+2$.
                    El problema nos dice que en este caso, el huevo nunca se 
                    rompe, pero como ya no podemos subir más pisos, entonces 
                    sabemos que el número mínimo para determinar a $f$ es 
                    $k+1$.
                \end{itemize}
            \end{itemize}
